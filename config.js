const config = {
  ...
  "sections": [
    ...
    },
    {
      ...
      "testimonial": {
        "quote": "\"We trust you completely. You delivered exactly what you said you would. When we first met, we thought our home would never sell and we'd be stuck with all this stress and uncertainty. Rick and Steve made the entire process effortless – no drama, no surprises, just results. We're now happily settled in our new smaller home closer to our children, and we couldn't be more grateful for how smoothly everything went.\"<br><span>— J.K.</span>"
      },
      "listItems": []
    },
    {
